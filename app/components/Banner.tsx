...
const Banner = () => {
  return (
    <section className="container mx-auto overflow-hidden rounded-[14px] border border-(--secondary-background) bg-(--secondary-background) font-(family-name:--primary-font) flex max-lg:flex-col justify-around">
      <div>
        {/* Banner content */}
        <div className="relative z-10 flex min-h-[360px] items-center px-8 py-10 lg:px-12 max-lg:min-h-[420px] max-lg:justify-center max-lg:text-center">
          <div className="max-w-[570px]">
            ...
            {/* Description */}
            <p className="mb-6 max-w-[500px] text-[15px] leading-6 text-(--primary-text-color) max-lg:mx-auto">
